...
def upload():
    ...
    if request.method == 'POST':
        ...
        processing.apply_async((filename_uuid, emotions, recognize, remember, current_user.email, ), countdown=15)
        return redirect('/')
...
if __name__ == "__main__":
    ...
    # celery -A app3.celery worker -l info -P eventlet --loglevel=info (запускаем в терминале2)
